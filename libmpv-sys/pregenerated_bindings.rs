...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_render_param"][::std::mem::size_of::<mpv_render_param>() - 16usize];
    ["Alignment of mpv_render_param"][::std::mem::align_of::<mpv_render_param>() - 8usize];
    ["Offset of field: mpv_render_param::type_"]
        [::std::mem::offset_of!(mpv_render_param, type_) - 0usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_render_frame_info"][::std::mem::size_of::<mpv_render_frame_info>() - 16usize];
    ["Alignment of mpv_render_frame_info"]
        [::std::mem::align_of::<mpv_render_frame_info>() - 8usize];
    ["Offset of field: mpv_render_frame_info::flags"]
        [::std::mem::offset_of!(mpv_render_frame_info, flags) - 0usize];
    ["Offset of field: mpv_render_frame_info::target_time"]
        [::std::mem::offset_of!(mpv_render_frame_info, target_time) - 8usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_opengl_init_params"][::std::mem::size_of::<mpv_opengl_init_params>() - 16usize];
    ["Alignment of mpv_opengl_init_params"]
        [::std::mem::align_of::<mpv_opengl_init_params>() - 8usize];
    ["Offset of field: mpv_opengl_init_params::get_proc_address"]
        [::std::mem::offset_of!(mpv_opengl_init_params, get_proc_address) - 0usize];
    ["Offset of field: mpv_opengl_init_params::get_proc_address_ctx"]
        [::std::mem::offset_of!(mpv_opengl_init_params, get_proc_address_ctx) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_opengl_fbo"][::std::mem::size_of::<mpv_opengl_fbo>() - 16usize];
    ["Alignment of mpv_opengl_fbo"][::std::mem::align_of::<mpv_opengl_fbo>() - 4usize];
    ["Offset of field: mpv_opengl_fbo::fbo"][::std::mem::offset_of!(mpv_opengl_fbo, fbo) - 0usize];
    ["Offset of field: mpv_opengl_fbo::w"][::std::mem::offset_of!(mpv_opengl_fbo, w) - 4usize];
    ["Offset of field: mpv_opengl_fbo::h"][::std::mem::offset_of!(mpv_opengl_fbo, h) - 8usize];
    ["Offset of field: mpv_opengl_fbo::internal_format"]
        [::std::mem::offset_of!(mpv_opengl_fbo, internal_format) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_opengl_drm_params"][::std::mem::size_of::<mpv_opengl_drm_params>() - 32usize];
    ["Alignment of mpv_opengl_drm_params"]
        [::std::mem::align_of::<mpv_opengl_drm_params>() - 8usize];
    ["Offset of field: mpv_opengl_drm_params::fd"]
        [::std::mem::offset_of!(mpv_opengl_drm_params, fd) - 0usize];
    ["Offset of field: mpv_opengl_drm_params::crtc_id"]
        [::std::mem::offset_of!(mpv_opengl_drm_params, crtc_id) - 4usize];
    ["Offset of field: mpv_opengl_drm_params::connector_id"]
        [::std::mem::offset_of!(mpv_opengl_drm_params, connector_id) - 8usize];
    ["Offset of field: mpv_opengl_drm_params::atomic_request_ptr"]
        [::std::mem::offset_of!(mpv_opengl_drm_params, atomic_request_ptr) - 16usize];
    ["Offset of field: mpv_opengl_drm_params::render_fd"]
        [::std::mem::offset_of!(mpv_opengl_drm_params, render_fd) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_opengl_drm_draw_surface_size"]
        [::std::mem::size_of::<mpv_opengl_drm_draw_surface_size>() - 8usize];
    ["Alignment of mpv_opengl_drm_draw_surface_size"]
        [::std::mem::align_of::<mpv_opengl_drm_draw_surface_size>() - 4usize];
    ["Offset of field: mpv_opengl_drm_draw_surface_size::width"]
        [::std::mem::offset_of!(mpv_opengl_drm_draw_surface_size, width) - 0usize];
    ["Offset of field: mpv_opengl_drm_draw_surface_size::height"]
        [::std::mem::offset_of!(mpv_opengl_drm_draw_surface_size, height) - 4usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_opengl_drm_params_v2"]
        [::std::mem::size_of::<mpv_opengl_drm_params_v2>() - 32usize];
    ["Alignment of mpv_opengl_drm_params_v2"]
        [::std::mem::align_of::<mpv_opengl_drm_params_v2>() - 8usize];
    ["Offset of field: mpv_opengl_drm_params_v2::fd"]
        [::std::mem::offset_of!(mpv_opengl_drm_params_v2, fd) - 0usize];
    ["Offset of field: mpv_opengl_drm_params_v2::crtc_id"]
        [::std::mem::offset_of!(mpv_opengl_drm_params_v2, crtc_id) - 4usize];
    ["Offset of field: mpv_opengl_drm_params_v2::connector_id"]
        [::std::mem::offset_of!(mpv_opengl_drm_params_v2, connector_id) - 8usize];
    ["Offset of field: mpv_opengl_drm_params_v2::atomic_request_ptr"]
        [::std::mem::offset_of!(mpv_opengl_drm_params_v2, atomic_request_ptr) - 16usize];
    ["Offset of field: mpv_opengl_drm_params_v2::render_fd"]
        [::std::mem::offset_of!(mpv_opengl_drm_params_v2, render_fd) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpv_stream_cb_info"][::std::mem::size_of::<mpv_stream_cb_info>() - 48usize];
    ["Alignment of mpv_stream_cb_info"][::std::mem::align_of::<mpv_stream_cb_info>() - 8usize];
    ["Offset of field: mpv_stream_cb_info::cookie"]
        [::std::mem::offset_of!(mpv_stream_cb_info, cookie) - 0usize];
    ["Offset of field: mpv_stream_cb_info::read_fn"]
        [::std::mem::offset_of!(mpv_stream_cb_info, read_fn) - 8usize];
    ["Offset of field: mpv_stream_cb_info::seek_fn"]
        [::std::mem::offset_of!(mpv_stream_cb_info, seek_fn) - 16usize];
    ["Offset of field: mpv_stream_cb_info::size_fn"]
        [::std::mem::offset_of!(mpv_stream_cb_info, size_fn) - 24usize];
    ["Offset of field: mpv_stream_cb_info::close_fn"]
        [::std::mem::offset_of!(mpv_stream_cb_info, close_fn) - 32usize];
    ["Offset of field: mpv_stream_cb_info::cancel_fn"]
        [::std::mem::offset_of!(mpv_stream_cb_info, cancel_fn) - 40usize];
};
